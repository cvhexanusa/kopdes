...
class NasabahController extends Controller
{
     ...
     */
    public function pdf($peran = null, $id = null)
    {
        $nasabah = Nasabah::with('instansi')->findOrFail($id);
        $user = auth()->user();
     ...
     */
    public function exportToDrive(Request $request, $peran = null, GoogleDriveService $driveService)
    {
        $request->validate([
            'ids' => 'required|array',
     ...
     */
    public function googleCallback(Request $request, $peran = null, GoogleDriveService $driveService)
    {
        if ($request->has('code')) {
